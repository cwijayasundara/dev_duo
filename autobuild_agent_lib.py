...
def build_agent_def():
    ...
    json.dump(sys_msg_list, open("./data_science_team.json", "w"), indent=4)


# build the agent definitions
# build_agent_def()

library_path_or_json = "./data_science_team.json"


def execute_agent_system(building_task, execution_task):
